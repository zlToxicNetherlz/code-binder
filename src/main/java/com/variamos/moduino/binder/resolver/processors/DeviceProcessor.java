package com.variamos.moduino.binder.resolver.processors;

import com.variamos.moduino.binder.api.json.binding.actions.ActionArgumentJson;
import com.variamos.moduino.binder.api.json.binding.relations.DeviceActionJson;
...
import com.variamos.moduino.binder.resolver.json.macros.MacroType;
import com.variamos.moduino.binder.resolver.json.variables.DeviceVariable;
import com.variamos.moduino.binder.resolver.json.variables.DeviceVariableType;
...
public class DeviceProcessor {
    ...
    public void processDeviceMacro(DeviceData device, HardwareProcessor hardwareProcessor) {
        ...
        com.variamos.moduino.binder.api.json.hardware.DeviceJson remote = device.getDeviceJson();
