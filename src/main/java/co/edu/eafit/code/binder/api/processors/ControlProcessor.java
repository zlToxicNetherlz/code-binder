...
import co.edu.eafit.code.binder.api.json.binding.relations.ControlActionPortJson;
import co.edu.eafit.code.binder.api.json.component.ControlComponentJson;
import co.edu.eafit.code.binder.api.json.control.ControllerJson;
import co.edu.eafit.code.binder.api.json.control.SetPointJson;
import co.edu.eafit.code.binder.api.json.control.SummingPointJson;
...
import co.edu.eafit.code.binder.model.variables.SketchPidVariable;
